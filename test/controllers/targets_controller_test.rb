...
class TargetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create target" do
    assert_difference("Target.count") do
      post targets_url, params: { target: { attr: @target.attr, desc: @target.desc, fDate: @target.fDate, name: @target.name, sDate: @target.sDate, status: @target.status, team: @target.team } }
    end
  ...
  test "should update target" do
    patch target_url(@target), params: { target: { attr: @target.attr, desc: @target.desc, fDate: @target.fDate, name: @target.name, sDate: @target.sDate, status: @target.status, team: @target.team } }
